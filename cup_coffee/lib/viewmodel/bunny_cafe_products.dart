...
class BunnyCafeReserves extends StatefulWidget {
  const BunnyCafeReserves({Key? key}) : super(key: key);

  @override
  State<BunnyCafeReserves> createState() => _BunnyCafeReservesState();
}

class _BunnyCafeReservesState extends State<BunnyCafeReserves> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder(
        stream: _cafeReserveService.getBunnyCafeProductsInfo(),
        builder: (BuildContext context, AsyncSnapshot asyncSnapshot) {
          if (asyncSnapshot.hasError) {
            return Center(child: Text('An error has occurred, try again!'));
          }
...
class BunnyCafePopularProducts extends StatefulWidget {
  const BunnyCafePopularProducts({Key? key}) : super(key: key);

  @override
  State<BunnyCafePopularProducts> createState() =>
      _BunnyCafePopularProductsState();
}

class _BunnyCafePopularProductsState extends State<BunnyCafePopularProducts> {
  ProductsService _cafeReserveService = ProductsService();
